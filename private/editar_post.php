...
if(isset($_POST['sub'])){
   ...
   if($deu_certo && $deu_certo2){
        ...
        $publicfunc->editarNoticia($id,$titulo, $subtitulo, $subtitulo2, $pasta . $novoNomeDoArquivo . "." . $extensao, $pasta2 . $novoNomeDoArquivo2 . "." . $extensao2, $link, $escritor, $creditos, $data_pub);
